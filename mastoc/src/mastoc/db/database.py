"""
Gestion de la base de données SQLite pour mastoc.
...
DEFAULT_DB_PATH = Path(__file__).parent.parent.parent.parent / "data" / "mastoc.db"
...
class Database:
    """Gestionnaire de base de données SQLite pour mastoc."""
