"""
Application principale mastock.
...
from mastock.core.sync import SyncManager
from mastock.gui.widgets.climb_list import ClimbListWidget
from mastock.gui.dialogs.login import LoginDialog, TokenExpiredDialog
...
class MastockApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("mastock - Climb Viewer")
...
def main():
    ...
    logger.info("Démarrage de mastock")

    app = QApplication(sys.argv)
    app.setApplicationName("mastock")
